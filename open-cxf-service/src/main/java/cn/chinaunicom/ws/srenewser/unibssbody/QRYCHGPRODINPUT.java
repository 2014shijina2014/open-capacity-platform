 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element ref="{http://ws.chinaunicom.cn/SrenewSer/unibssBody/qryChgProdReq}QRY_CHG_PROD_REQ"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlRootElement(name = "QRY_CHG_PROD_INPUT")
public class QRYCHGPRODINPUT {
    ...
    protected QRYCHGPRODINPUT.UNIBSSBODY unibssbody;
     ...
     * @return
     *     possible object is
     *     {@link QRYCHGPRODINPUT.UNIBSSBODY }
     *     
     */
    public QRYCHGPRODINPUT.UNIBSSBODY getUNIBSSBODY() {
        return unibssbody;
    }
     ...
     *     
     */
    public void setUNIBSSBODY(QRYCHGPRODINPUT.UNIBSSBODY value) {
    ...
    public static class UNIBSSBODY {
        ...
        @XmlElement(name = "QRY_CHG_PROD_REQ", namespace = "http://ws.chinaunicom.cn/SrenewSer/unibssBody/qryChgProdReq", required = true)
        protected QRYCHGPRODREQ qrychgprodreq;

        /**
         * Gets the value of the qrychgprodreq property.
         * 
         * @return
         *     possible object is
         *     {@link QRYCHGPRODREQ }
         *     
         */
        public QRYCHGPRODREQ getQRYCHGPRODREQ() {
            return qrychgprodreq;
        }

        /**
         * Sets the value of the qrychgprodreq property.
         * 
         * @param value
         *     allowed object is
         *     {@link QRYCHGPRODREQ }
         *     
         */
        public void setQRYCHGPRODREQ(QRYCHGPRODREQ value) {
            this.qrychgprodreq = value;
        }
