 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element ref="{http://ws.chinaunicom.cn/SrenewSer/unibssBody/qryChgProdRsp}QRY_CHG_PROD_RSP"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlRootElement(name = "QRY_CHG_PROD_OUTPUT")
public class QRYCHGPRODOUTPUT {
    ...
    protected QRYCHGPRODOUTPUT.UNIBSSBODY unibssbody;
     ...
     * @return
     *     possible object is
     *     {@link QRYCHGPRODOUTPUT.UNIBSSBODY }
     *     
     */
    public QRYCHGPRODOUTPUT.UNIBSSBODY getUNIBSSBODY() {
        return unibssbody;
    }
     ...
     *     
     */
    public void setUNIBSSBODY(QRYCHGPRODOUTPUT.UNIBSSBODY value) {
    ...
    public static class UNIBSSBODY {
        ...
        @XmlElement(name = "QRY_CHG_PROD_RSP", namespace = "http://ws.chinaunicom.cn/SrenewSer/unibssBody/qryChgProdRsp", required = true)
        protected QRYCHGPRODRSP qrychgprodrsp;

        /**
         * Gets the value of the qrychgprodrsp property.
         * 
         * @return
         *     possible object is
         *     {@link QRYCHGPRODRSP }
         *     
         */
        public QRYCHGPRODRSP getQRYCHGPRODRSP() {
            return qrychgprodrsp;
        }

        /**
         * Sets the value of the qrychgprodrsp property.
         * 
         * @param value
         *     allowed object is
         *     {@link QRYCHGPRODRSP }
         *     
         */
        public void setQRYCHGPRODRSP(QRYCHGPRODRSP value) {
            this.qrychgprodrsp = value;
        }
