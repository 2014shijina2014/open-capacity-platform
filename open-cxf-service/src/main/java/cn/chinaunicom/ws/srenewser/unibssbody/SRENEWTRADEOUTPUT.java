 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;sequence>
 *                   &lt;element ref="{http://ws.chinaunicom.cn/SrenewSer/unibssBody/srenewTradeRsp}SRENEW_TRADE_RSP"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlRootElement(name = "SRENEW_TRADE_OUTPUT")
public class SRENEWTRADEOUTPUT {
    ...
    protected SRENEWTRADEOUTPUT.UNIBSSBODY unibssbody;
     ...
     * @return
     *     possible object is
     *     {@link SRENEWTRADEOUTPUT.UNIBSSBODY }
     *     
     */
    public SRENEWTRADEOUTPUT.UNIBSSBODY getUNIBSSBODY() {
        return unibssbody;
    }
     ...
     *     
     */
    public void setUNIBSSBODY(SRENEWTRADEOUTPUT.UNIBSSBODY value) {
    ...
    public static class UNIBSSBODY {
        ...
        @XmlElement(name = "SRENEW_TRADE_RSP", namespace = "http://ws.chinaunicom.cn/SrenewSer/unibssBody/srenewTradeRsp", required = true)
        protected SRENEWTRADERSP srenewtradersp;

        /**
         * Gets the value of the srenewtradersp property.
         * 
         * @return
         *     possible object is
         *     {@link SRENEWTRADERSP }
         *     
         */
        public SRENEWTRADERSP getSRENEWTRADERSP() {
            return srenewtradersp;
        }

        /**
         * Sets the value of the srenewtradersp property.
         * 
         * @param value
         *     allowed object is
         *     {@link SRENEWTRADERSP }
         *     
         */
        public void setSRENEWTRADERSP(SRENEWTRADERSP value) {
            this.srenewtradersp = value;
        }
