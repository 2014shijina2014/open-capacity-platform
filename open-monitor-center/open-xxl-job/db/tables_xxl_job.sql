...
INSERT INTO `XXL_JOB_QRTZ_TRIGGER_INFO` VALUES (3,1,'1 1 1 * * ? *','无参Demo测试','2018-05-09 22:38:50','2018-05-09 22:38:50','Merlin','','FIRST','demoJobHandler','','SERIAL_EXECUTION','FAIL_ALARM','BEAN','','GLUE代码初始化','2018-05-09 22:38:50',''),(4,1,'1 1 1 * * ? *','有参Demo测试','2018-05-09 22:39:38','2018-05-09 22:39:38','Merlin','','FIRST','demoJobHandler','Hello,Word','SERIAL_EXECUTION','FAIL_ALARM','BEAN','','GLUE代码初始化','2018-05-09 22:39:38','');
...
INSERT INTO `XXL_JOB_QRTZ_TRIGGERS` VALUES ('quartzScheduler','3','1','3','1',NULL,1525885261000,-1,5,'PAUSED','CRON',1525876730000,0,NULL,2,X''),('quartzScheduler','4','1','4','1',NULL,1525885261000,-1,5,'PAUSED','CRON',1525876778000,0,NULL,2,X'');
...
INSERT INTO `XXL_JOB_QRTZ_CRON_TRIGGERS` VALUES ('quartzScheduler','3','1','1 1 1 * * ? *','Asia/Shanghai'),('quartzScheduler','4','1','1 1 1 * * ? *','Asia/Shanghai');
