...
INSERT INTO `XXL_JOB_QRTZ_JOB_DETAILS` VALUES ('schedulerFactoryBean','1','1',NULL,'com.open.capacity.core.jobbean.RemoteHttpJobBean','0','0','0','0',X'');
...
INSERT INTO `XXL_JOB_QRTZ_LOCKS` VALUES ('schedulerFactoryBean','STATE_ACCESS'),('schedulerFactoryBean','TRIGGER_ACCESS');
...
INSERT INTO `XXL_JOB_QRTZ_SCHEDULER_STATE` VALUES ('schedulerFactoryBean','owen1526012191527',1526012292439,5000);
...
CREATE TABLE `XXL_JOB_QRTZ_TRIGGER_INFO` (
  ...
  `child_jobkey` varchar(255) DEFAULT NULL COMMENT '子任务ID，多个逗号分隔',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
...
INSERT INTO `XXL_JOB_QRTZ_TRIGGER_INFO` VALUES (1,1,'0 0/3 * * * ?','owen','2018-05-07 22:42:15','2018-05-07 22:42:15','owen','624191343@qq.com','FIRST','demoJobHandler','1','SERIAL_EXECUTION','FAIL_ALARM','BEAN','','GLUE代码初始化','2018-05-07 22:42:15','');
...
INSERT INTO `XXL_JOB_QRTZ_TRIGGER_LOG` VALUES (16,1,1,'BEAN',NULL,'demoJobHandler','1','2018-05-10 22:18:00','500','注册方式：自动注册<br>阻塞处理策略：单机串行<br>失败处理策略：失败告警<br>地址列表：null<br>路由策略：第一个<br>----------------------<br>调度失败：执行器地址为空',NULL,'0',NULL),(17,1,1,'BEAN',NULL,'demoJobHandler','1','2018-05-10 22:21:00','500','注册方式：自动注册<br>阻塞处理策略：单机串行<br>失败处理策略：失败告警<br>地址列表：null<br>路由策略：第一个<br>----------------------<br>调度失败：执行器地址为空',NULL,'0',NULL),(18,1,1,'BEAN',NULL,'demoJobHandler','1','2018-05-10 22:24:00','500','注册方式：自动注册<br>阻塞处理策略：单机串行<br>失败处理策略：失败告警<br>地址列表：null<br>路由策略：第一个<br>----------------------<br>调度失败：执行器地址为空',NULL,'0',NULL),(19,1,1,'BEAN',NULL,'demoJobHandler','1','2018-05-11 12:18:00','500','注册方式：自动注册<br>阻塞处理策略：单机串行<br>失败处理策略：失败告警<br>地址列表：null<br>路由策略：第一个<br>----------------------<br>调度失败：执行器地址为空',NULL,'0',NULL);
...
INSERT INTO `XXL_JOB_QRTZ_TRIGGERS` VALUES ('schedulerFactoryBean','1','1','1','1',NULL,1526012460000,1526012280000,5,'WAITING','CRON',1525955352000,0,NULL,2,X'');
...
INSERT INTO `XXL_JOB_QRTZ_CRON_TRIGGERS` VALUES ('schedulerFactoryBean','1','1','0 0/3 * * * ?','GMT+08:00');
